...
class DialogAbout : DialogFragment() {
    interface Listener {
        fun onAboutDialogPositiveClick(dialog : DialogFragment)
    }
    ...
    override fun onAttach(context : Context) {
        ...
        try {
            ...
            throw ClassCastException(context.toString()
                    + " must implement DialogAbout.Listener")
        }
    }
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        builder.setMessage("Hecho por Gaston Rios y Sebastian Raimondi")
                .setPositiveButton("Ok") { _, _ ->
                    // Send the positive button event back to the host activity
                    mListener.onAboutDialogPositiveClick(this@DialogAbout)
                }
